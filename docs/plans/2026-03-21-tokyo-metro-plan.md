...
**Goal:** Issue `#9` の残りとして、東京メトロの代表形式を8件追加する。
...
## Task 2: seed 正本へ8件を追加する

- `data/train-seeds.json` に東京メトロ8件を追加する
- `1000 / 2000 / 13000 / 15000 / 16000 / 17000 / 18000 / 9000` の記事タイトルと Commons 画像を確認して seed に固定する
- `17000系` は副都心線だけ残し、有楽町線ぶんは見た目重複を避けて追加しない
...
- 東京メトロ8件が `data/trains.json` に出力される
